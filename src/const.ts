 ...
 * 예식 장소 명칭
 */
export const LOCATION = "로얄파크컨벤션 3층 로얄홀"

/**
 * 예식 장소 상세 주소
 */
export const LOCATION_ADDRESS = "서울특별시 용산구 이태원로 29, 3층 로얄홀"
...
export const BRIDE_FIRSTNAME = "나윤"
export const BRIDE_TITLE = "장녀"
export const BRIDE_FATHER = "김재원"
export const BRIDE_MOTHER = "차지은"
...
export const BRIDE_INFO = [
  {
    ...
    name: BRIDE_FULLNAME,
    phone: "010-3210-6384",
    account: "우리은행 1002-751-617685",
  },
  {
    relation: "신부 아버지",
    name: BRIDE_FATHER,
    phone: "010-2887-6384",
    account: "우리은행 1002-931-754617",
  },
  {
    relation: "신부 어머니",
    name: BRIDE_MOTHER,
    phone: "010-2885-6384",
    account: "우리은행 341-032711-02-201",
  },
]

// 신랑 정보 설정
export const GROOM_FULLNAME = "유광현"
export const GROOM_FIRSTNAME = "광현"
export const GROOM_TITLE = "차남"
export const GROOM_FATHER = "유재봉"
export const GROOM_MOTHER = "김미경"
...
export const GROOM_INFO = [
  {
    ...
    name: GROOM_FULLNAME,
    phone: "010-0000-0000",
    account: "국민은행 037601-04-070314",
  },
  {
    relation: "신랑 아버지",
    name: GROOM_FATHER,
    phone: "010-5266-1355",
    account: "우리은행 365-07-053008",
  },
  {
    relation: "신랑 어머니",
    name: GROOM_MOTHER,
    phone: "010-4752-1335",
    account: "우리은행 1002-429-319272",
  },
]
