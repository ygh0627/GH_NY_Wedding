  ...
  return (
    <>
      <LazyDiv className="card invitation">
        ...
        <div style={{ marginTop: "0.3rem", marginBottom: "0.2rem" }} className="content">소중한 인연의 결실을 맺으려 합니다.</div>
        ...
        <div style={{ marginTop: "0.3rem", marginBottom: "0.2rem" }} className="content">평생을 함께 나아가겠습니다.</div>
